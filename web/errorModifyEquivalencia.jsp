<%-- 
    Document   : errorModifyEquivalencia
    Created on : 02/10/2013, 02:12:22 AM
    Author     : andreso
--%>
...
<html>
    <head>
        ...
        <title>SEA - Equivalencia no fue modificada con éxito</title>
    </head>
    <body>
        <h1>Error. No fue posible modificar la equivalencia.</h1>
