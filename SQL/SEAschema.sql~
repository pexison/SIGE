...
ALTER TABLE RECAUDO
    ADD CONSTRAINT PK_RECAUDO PRIMARY KEY (CODIGO_PLANILLA, TIPO_RECAUDO,DATOS_RECAUDO),
    ADD CONSTRAINT FK_RECAUDO_PLANILLA FOREIGN KEY (CODIGO_PLANILLA) REFERENCES PLANILLA (CODIGO_PLANILLA),
    ADD CONSTRAINT DOM_CHECK_TIPO_RECAUDO CHECK (TIPO_RECAUDO IN ('Diploma de Carrera Original', 'Calificaciones', 'Pensum de Estudios'));
